...
class Frage(models.Model):
    name = models.CharField(max_length=200,blank=False,help_text='Geben Sie den Namen der Frage ein')
    ...
    antwort1richtig = models.BooleanField(default=False,help_text='Geben Sie an ob Antwort1 richtig ist')
    antwort2 = models.CharField(max_length=255,blank=False,null=True,help_text='Geben Sie die Antwort2 der Frage ein')
    antwort2richtig = models.BooleanField(default=False,help_text='Geben Sie an ob Antwort2 richtig ist')
    antwort3 = models.CharField(max_length=255,blank=True,null=True,help_text='Geben Sie die Antwort3 der Frage ein (optional)')
    antwort3richtig = models.BooleanField(default=False,help_text='Geben Sie an ob Antwort3 richtig ist')
    antwort4 = models.CharField(max_length=255,blank=True,null=True,help_text='Geben Sie die Antwort4 der Frage ein (optional)')
    antwort4richtig = models.BooleanField(default=False,help_text='Geben Sie an ob Antwort4 richtig ist')
